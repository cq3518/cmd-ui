    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="机构" align="center" prop="dept.deptName" :show-overflow-tooltip="true" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属机构" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :disable-branch-nodes="true" :show-count="true" placeholder="请选择归属机构" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
